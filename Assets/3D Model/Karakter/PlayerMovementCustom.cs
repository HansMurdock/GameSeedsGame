...
public class PlayerMovementCustom : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Animator Speed parameter (buat transition Idle/Walking/Running)
        float horizontalSpeed = new Vector3(curSpeedX, 0, curSpeedY).magnitude;
        if (animator != null) animator.SetFloat("Speed", horizontalSpeed);
